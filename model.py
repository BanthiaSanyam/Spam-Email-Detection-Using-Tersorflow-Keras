...
# Inspect the  rows and column names
print(data.columns)  

# Rename columns for easier access
data.columns = ['label', 'text', '_1', '_2', '_3']  
...
non_spam_data = data[data.spam == 0].sample(len(spam_data), random_state=88)  
...
history = model.fit(
    ...
    epochs=16, batch_size=64, callbacks=[early_stopping]
)
